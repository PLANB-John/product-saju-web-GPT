  ...
  return (
    <div className="section-gap">
      <section className="surface-card relative overflow-hidden fade-up">
        <div className="absolute -right-12 -top-12 h-40 w-40 rounded-full bg-fuchsia-200/40 blur-3xl" />
        <div className="absolute -bottom-20 left-10 h-40 w-40 rounded-full bg-violet-200/40 blur-3xl" />
