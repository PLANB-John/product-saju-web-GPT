      ...
      <section className="surface-card relative overflow-hidden fade-up">
        <div className="relative space-y-4 sm:space-y-5">
          ...
          <div className="surface-muted">
            <p className="text-xs font-semibold uppercase tracking-[0.12em] text-[#666666]">Report Experience</p>
          ...
          <div className="grid gap-2.5 sm:grid-cols-3 sm:gap-3">
            <div className="rounded-2xl border border-[#E9E9E9] bg-white p-3">
              <p className="text-xs text-[#666666]">해석 구성</p>
              <p className="mt-1 text-sm font-semibold text-black">핵심 요약 · 조율 포인트</p>
            </div>
            <div className="rounded-2xl border border-[#E9E9E9] bg-[#F6E8EC] p-3">
              <p className="text-xs text-[#666666]">읽는 시간</p>
              <p className="mt-1 text-sm font-semibold text-black">약 2분, 한 번에 읽기</p>
            </div>
            <div className="rounded-2xl border border-[#E9E9E9] bg-white p-3">
              <p className="text-xs text-[#666666]">읽고 난 뒤</p>
              <p className="mt-1 text-sm font-semibold text-black">대화를 시작할 기준이 남아요</p>
            </div>
          </div>
